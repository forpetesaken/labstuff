...
BASE=/home/atforpetesaken/consurf_runs/ctcf_allseq_20260707
...
cp /mnt/c/Users/Nat/Downloads/Bioinformatics/updated_alignment_0611.fas "$BASE/input/ctcf_raw.fasta"

python3 - <<'PY'
from pathlib import Path
inp = Path('/home/atforpetesaken/consurf_runs/ctcf_allseq_20260707/input/ctcf_raw.fasta')
out = Path('/home/atforpetesaken/consurf_runs/ctcf_allseq_20260707/input/ctcf_full_all69.fasta')
records = []
header = None
buf = []
...
perl /home/atforpetesaken/consurf_ws/consurf \
  -MSA "$BASE/input/ctcf_full_all69.fasta" \
  -SEQ_NAME Human_CTCF \
  -Out_Dir "$BASE/out_full" \
  -w "$BASE/work_full"

echo "CTCF all-sequence full ConSurf run complete"
