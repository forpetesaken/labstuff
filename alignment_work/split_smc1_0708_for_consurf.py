...
IN_FASTA = Path(r"C:\Users\Nat\Downloads\AIDEN Lab\Code\alignment_work\ConSurf\output\SMC1\SMC1_0708.fas")
OUT_DIR = Path(r"C:\Users\Nat\Downloads\AIDEN Lab\Code\alignment_work\ConSurf\input_splits\SMC1")
...
def main():
    ...
    full_s = sanitize(records, "ALL", "human", "Human_SMC1")
    write_fasta(OUT_DIR / "smc1_full_all.fasta", full_s)

    vert_s = sanitize(vertebrates, "VERT", "human", "Human_SMC1")
    write_fasta(OUT_DIR / "smc1_vertebrates_0708_sanitized.fasta", vert_s)

    invert_s = sanitize(invertebrates, "INVERT", "ciona", "Ciona_intestinalis")
    write_fasta(OUT_DIR / "smc1_invertebrates_0708_sanitized.fasta", invert_s)
    ...
    summary = [
        ...
        "Vertebrate query: Human_SMC1",
        "Invertebrate query: Ciona_intestinalis",
    ]
    (OUT_DIR / "smc1_0708_split_summary.txt").write_text("\n".join(summary) + "\n", encoding="utf-8")
    print("Done")
